          ...
          <div className="relative pt-24 md:pt-36">
            ...
            >
              <div className="h-screen xl:h-auto absolute inset-2 -z-10 overflow-hidden rounded-3xl border border-black/10 lg:aspect-video lg:rounded-[3rem] dark:border-white/5">
                <video autoPlay loop muted preload="auto" className="size-full -scale-x-100 object-cover opacity-50 invert-0 dark:opacity-35 dark:invert ">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                <TextEffect per="line" preset="fade-in-blur" speedSegment={0.3} delay={0.5} as="p" className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                  Digital Content Design Student at Medieinstitutet, Malmö. I specialize in engaging digital experiences through innovative design and creative
                  solutions.
                </TextEffect>
