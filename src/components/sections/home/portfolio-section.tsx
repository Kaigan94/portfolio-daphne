    ...
    <section className="py-16 md:py-32 bg-gray-50 dark:bg-transparent" id="portfolio">
      <div className="mx-auto max-w-5xl space-y-12 px-6">
        <div className="relative z-10 grid items-center gap-4 md:grid-cols-2 md:gap-12">
          <h2 className="text-4xl font-semibold">Take a peek at some of my projects!</h2>
          <p className="max-w-sm sm:ml-auto">
            Scroll through a selection of my recent work, showcasing a variety of projects that highlight my skills and creativity in design and development.
          </p>
        </div>
