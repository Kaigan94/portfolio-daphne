      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <TextEffect preset="fade-in-blur" speedSegment={0.3} as="h1" className="text-balance text-5xl font-medium md:text-6xl">
            Elevate your portfolio with a stunning, modern web experience.
          </TextEffect>
          <TextEffect per="line" preset="fade-in-blur" speedSegment={0.3} delay={0.5} as="p" className="mx-auto mt-6 max-w-2xl text-pretty text-lg">
            Built with Next.js, Tailwind, and Motion Primitives — a fast, elegant site featuring a smooth portfolio, a powerful CMS preview, and thoughtful
            features designed to elevate creative work. Full experience launching soon.
          </TextEffect>
          ...
          <AnimatedGroup
            ...
            className="mt-12"
          >
            <form action={process.env.NEXT_PUBLIC_WAIT_LIST_API} className="mx-auto max-w-sm" method="POST">
              <div className="bg-background has-[input:focus]:ring-muted relative grid grid-cols-[1fr_auto] items-center rounded-[calc(var(--radius)+0.5rem)] border pr-2 shadow shadow-zinc-950/5 has-[input:focus]:ring-2">
                <Mail className="pointer-events-none absolute inset-y-0 left-4 my-auto size-4" />

                <input placeholder="Your mail address" className="h-12 w-full bg-transparent pl-12 focus:outline-none" type="email" name="email" required />
                ...
                <div className="bg-background space-y-2 overflow-hidden rounded-[1.5rem] border p-2 shadow-xl dark:bg-white/5 dark:shadow-black dark:backdrop-blur-3xl">
                  <div className="relative space-y-3 rounded-[1rem] bg-white/5 p-4">
                    ...
                    <div className="space-y-3">
                      <Image src="/images/abstract-3.png" alt="pro-filler" height={300} width={500} className="rounded-full" />
                    </div>
                  </div>
